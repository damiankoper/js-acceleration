...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__Z5printv')) {
        Object.defineProperty(Module['ready'], '__Z5printv', { configurable: true, get: function() { abort('You are getting __Z5printv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__Z5printv', { configurable: true, set: function() { abort('You are setting __Z5printv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var __Z5printv = Module["__Z5printv"] = createExportWrapper("_Z5printv");

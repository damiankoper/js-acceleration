...
\begin{figure}
    \begin{tikzpicture}
        \begin{axis} [
            ...
            \plotColdstart{coldstart/js-sequential_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            ...
            \plotColdstart{coldstart/js-wasm_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            ...
            \plotColdstart{coldstart/js-asm_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            \addlegendentry{asm.js (LUT)}

            % SIMD impl
            \plotColdstart{coldstart/js-wasm_simd_implicit_coldstart_SHT_Simple_Chrome.csv}{{}}
            \addlegendentry{WASM SIMD (impl.)}
            \pgfplotsset{cycle list shift=-4}
            \plotColdstart{coldstart/js-wasm_simd_implicit_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            ...
            \plotColdstart{coldstart/js-wasm_simd_explicit_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            ...
            \plotColdstart{coldstart/js-workers_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}
            ...
            \plotColdstart{coldstart/js-gpu_coldstart_SHT_Simple_Lookup_Chrome.csv}{dashed}

...
\begin{figure}
    ...
    \label{plot:workers}
    \caption{Workers SHT execution benchmark results with concurrency $n=4$. Gray area shows sequential JavaScript execution performance range. Non-lookup variant performs better than sequential execution. On the other hand lookup one has gained only small increase in performance.}
    % TODO: speedup math
\end{figure}

...
\input{chapters/03-methods_results}
\input{chapters/04-comparison}
...
% \input{charts/coldstart_deno}
% \input{charts/coldstart_chrome}
% \input{charts/coldstart_firefox}
% \input{charts/environments_wasm}
% \input{charts/environments_multi_threaded}
% \input{tables/envs}
\begin{appendices}

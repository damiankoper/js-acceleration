...
%\setlength{\fboxrule}{0.1mm} %% INFO: Je�li chcemy zobaczy� ramk�, wystarczy odmarkowa� t� linijk�
...
{\fontsize{26pt}{28pt}\selectfont P}RACA {\fontsize{26pt}{24pt}\selectfont DYPLOMOWA}\\[7pt]
{\fontsize{26pt}{28pt}\selectfont MAGISTERSKA}\\[2.5cm]
}
\vfill
{\centering
...
\kierunek{Informatyka techniczka}

...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Autorska implementacja algorytmów transformacji Hougha dla wybranych metod akceleracji obliczeń w środowiskach języka JavaScript}
\titleShort{Implementacja algorytmów transformacji Hougha}
